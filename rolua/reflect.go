...
func (W _reflect_Type) CanSeq() bool {
	return W.WCanSeq()
}
func (W _reflect_Type) CanSeq2() bool {
	return W.WCanSeq2()
}
...
func (W _reflect_Type) OverflowComplex(x complex128) bool {
	return W.WOverflowComplex(x)
}
func (W _reflect_Type) OverflowFloat(x float64) bool {
	return W.WOverflowFloat(x)
}
func (W _reflect_Type) OverflowInt(x int64) bool {
	return W.WOverflowInt(x)
}
func (W _reflect_Type) OverflowUint(x uint64) bool {
	return W.WOverflowUint(x)
}
